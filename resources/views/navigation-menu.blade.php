        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('acopios.index') }}" :active="request()->routeIs('acopios.index')">
                        {{ __('Acopios') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('recibas.index') }}" :active="request()->routeIs('recibas.index')">
                        {{ __('Reciba') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('tarimas.index') }}" :active="request()->routeIs('tarimas.index')">
                        {{ __('Tipo tarimas') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('cajas.index') }}" :active="request()->routeIs('cajas.index')">
                        {{ __('Cajas') }}
                    </x-nav-link>
